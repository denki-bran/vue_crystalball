<template>
	<div class="8bits-wrapper">
		<div class="emblem"><span class="icon-information"></span></div>
	    <div class="frame">
	    <div class="piece output content" style="padding-top: 0;">
	      <div class="header-content clearfix" id="_bfPoint" style="display: block;">
	        <p class="header">距<span class="year">2020</span></p>
	      ...
	      <p style="margin:0;">Don't wait for counterattack</p>
	      <p style="margin:0;">Let's fight for counterattack</p>
	    </div>
